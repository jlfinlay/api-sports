...
public class BetSubmitVO extends BaseVO {
    ...
    @ApiModelProperty(value = "本地投注订单号",name = "localBetNO",hidden = true)
    private String localBetNO;

    @ApiModelProperty(value = "体育类型", name = "sportType", required = true)
    @NotNull
